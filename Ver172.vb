Public Class Ver172
    ...
    Sub install_vanilla()
        ...
        My.Computer.FileSystem.WriteAllText(Main.TextBox1.Text & "\versions\mod-kit\mod-kit.json", My.Computer.FileSystem.ReadAllText(Main.TextBox1.Text & "\versions\mod-kit\mod-kit.json").Replace("Main" & """",
                                                                                                                                                                                                     "Main" & """" & "," & vbCrLf & "  " & """" & "minimumLauncherVersion" & """" & ": 9"), False)
        My.Computer.FileSystem.WriteAllText(Main.TextBox1.Text & "\versions\mod-kit\mod-kit.json", My.Computer.FileSystem.ReadAllText(Main.TextBox1.Text & "\versions\mod-kit\mod-kit.json").Replace("      " & """" & "natives" & """" & ": {" & Chr(10) & "        " & """" & "linux" & """" & ": " & """" & "natives-linux" & """" & "," & Chr(10) & "        " & """" & "windows" & """" & ": " & """" & "natives-windows" & """" & Chr(10) & "      " & "}," & Chr(10) & "      " & """" & "extract" & """" & ": {" & Chr(10) & "        " & """" & "exclude" & """" & ": [" & Chr(10) & "          " & """" & "META-INF/" & """" & Chr(10) & "        " & "]" & Chr(10) & "      " & "}," & Chr(10) & "      " & """" & "rules" & """" & ": [" & Chr(10) & "        " & "{" & Chr(10) & "          " & """" & "action" & """" & ": " & """" & "allow" & """" & Chr(10) & "        " & "}," & Chr(10) & "        " & "{" & Chr(10) & "          " & """" & "action" & """" & ": " & """" & "disallow" & """" & "," & Chr(10) & "          " & """" & "os" & """" & ": {" & Chr(10) & "            " & """" & "name" & """" & ": " & """" & "osx" & """" & Chr(10) & "          " & "}" & Chr(10) & "        " & "}" & Chr(10) & "      " & "]",
