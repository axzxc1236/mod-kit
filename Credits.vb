Public Class Credits
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        ...
        PictureBox1.Image = New System.Drawing.Bitmap(New IO.MemoryStream(New System.Net.WebClient().DownloadData("http://i.minus.com/ibiazGMDvy47Dn.png")))
    End Sub

    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        LinkLabel1.Text = "ProfMobius模組網站"
        Label2.Text = "http://www.mobiusstrip.eu/"
        PictureBox1.Image = New System.Drawing.Bitmap(New IO.MemoryStream(New System.Net.WebClient().DownloadData("http://i.minus.com/if1AvDeCLCC5n.png")))
    End Sub

    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        LinkLabel1.Text = "iChun模組網站"
        Label2.Text = "http://ichun.us/"
        PictureBox1.Image = New System.Drawing.Bitmap(New IO.MemoryStream(New System.Net.WebClient().DownloadData("http://i.minus.com/ib43pmH7CO6dh.png")))
    End Sub

    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        LinkLabel1.Text = "Chicken Bones模組網站"
        Label2.Text = "http://chickenbones.craftsaddle.org/"
        PictureBox1.Image = New System.Drawing.Bitmap(New IO.MemoryStream(New System.Net.WebClient().DownloadData("http://i.minus.com/idvdKAb4Cmbz8.png")))
    End Sub

    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        LinkLabel1.Text = "Craft Guide模組原網"
        Label2.Text = "http://www.minecraftforum.net/topic/731133-"
        PictureBox1.Image = New System.Drawing.Bitmap(New IO.MemoryStream(New System.Net.WebClient().DownloadData("http://i.minus.com/ibgEFAqWzr30DV.png")))
    End Sub
